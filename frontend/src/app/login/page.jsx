export default function Login() {
    return <>
        <div className="d-flex vh-100">
            ...
            {/* Div logo */}
            <div className="col-6 fundoAzul1 d-flex justify-content-center align-itens-center">
            ...
            <div className="col-6 shadow-lg border d-flex justify-content-center align-itens-center">
                <form>
                    ...
                    <div className="form-check text-start my-3">
                        ...
                        <label className="form-check-label" htmlFor="checkDefault">Lembre de me</label>
                    </div>
